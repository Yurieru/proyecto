...
namespace Misistema_DAP2_2017_4_1
{
    public partial class frmCatClientes : Form
    {
        ...
        public frmCatClientes(bool seleccionar) //constructor alterno
        {
            InitializeComponent();
        ...
        private void prepararForma()
        {
            ...
            {
                ds = ctrl_clientes.LeerClientes();
            }
            else
            {
                ds = ctrl_clientes.LeerClientes(txtBuscar.Text);
            }
        ...
        {
            frmUpdateClientes agregar = new frmUpdateClientes();
            agregar.ShowDialog();
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            frmUpdateClientes modif = new frmUpdateClientes(dato_id);
            modif.ShowDialog();
            if (modif.HuboCambio)
            {
                prepararForma(); //Si hay cambios, actualiza el datagridview1
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                string error = "";
                if (ctrl_clientes.eliminarClientes(dato_id, ref error))
                {
                    prepararForma();
                }
                else
        ...
        private void imprimeEnHTML(string documento)
        {
            ...
            tw.WriteLine("<H2>Listado de clientes</H2>");
            tw.WriteLine("<BR>");
            ...
            foreach (DataGridViewRow r in dataGridView1.Rows)
            {
                ...
                linea = linea + "<TD>" + r.Cells["nombre"].Value + "</TD> ";
                linea = linea + "<TD>" + r.Cells["apellidos"].Value + "</TD> ";
        ...
        private void imprimeConExcel(string nom_libro, string nom_hoja)
        {
            ...
            //    hoja.Cells[3 + x, "B"] = r.Cells["nombre"].Value.ToString();
            //    hoja.Cells[3 + x, "C"] = r.Cells["apellidos"].Value.ToString();
    ...
    //        //miWord.Selection.TypeText("Listado de clientes" + nl + nl);
    ...
    //        ////Imprimir los encabezados:
    //        //miWord.Selection.TypeText("clave               nombre                apellidos           telefono             colonia            codigo postal               ciudad              estado" + nl);
    ...
    //        //foreach (DataGridViewRow r in dataGridView1.Rows)
    //        //{
    //        //    linea = r.Cells["clave"].Value.ToString().PadRight(20).Substring(0,20) + " " +
    //        //        r.Cells["nombre"].Value.ToString().PadRight(20).Substring(0, 20) + " " +
    //        //         r.Cells["apellidos"].Value.ToString().PadRight(20).Substring(0, 20) + " " +
    //        //          r.Cells["telefono"].Value.ToString().PadRight(20).Substring(0, 20) + " " +
    //        //           //r.Cells["calle_y_num"].Value.ToString().PadRight(20) + " " +
    //        //          // r.Cells["entre_calles"].Value.ToString().PadRight(20) + " " +
    //        //             r.Cells["colonia"].Value.ToString().PadRight(20).Substring(0, 20) + " " +
    //        //              r.Cells["codigo_postal"].Value.ToString().PadRight(20).Substring(0, 20) + " " +
    ...
    //    }
        ...
        //{
        //    //clave_cli = dataGridView1[0, dataGridView1.CurrentRow.Index].Value.ToString();
        //    //nombre = dataGridView1[1, dataGridView1.CurrentRow.Index].Value.ToString() + "" +
        //    //         dataGridView1[2, dataGridView1.CurrentRow.Index].Value.ToString();
        //    //telefono = dataGridView1[3, dataGridView1.CurrentRow.Index].Value.ToString();
        //    //this.Close();
        //}
